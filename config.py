...
CHANNEL_DB = int(os.environ.get("CHANNEL_DB", "-1001793594030"))
DATABASE_URL = os.environ.get("DATABASE_URL", "postgres://gromkzdt:dzj-tytwpkowrpJ7_kBWuasUp7dP-qJ1@rogue.db.elephantsql.com/gromkzdt")

RESTRICT = strtobool(os.environ.get("RESTRICT", "True"))

FORCE_SUB_1 = int(os.environ.get("FORCE_SUB_1", "-1001913948636"))
...
try:
    ADMINS = [int(x) for x in (os.environ.get("ADMINS", "2043875071 1215482484 5178772086 6247819220").split())]
except ValueError:
